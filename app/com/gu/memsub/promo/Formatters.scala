...
object Formatters {
  ...
  object Common {
    ...
    implicit val prpIdFormat = Format.GenericFormat[String].inmap[ProductRatePlanId](ProductRatePlanId, _.get)
    ...
    implicit val dateTimeReads = play.api.libs.json.JodaReads.jodaDateReads(dateFormat)
  ...
  object PromotionFormatters {
    ...
    implicit val prpIdSetFormat = Format(Reads.set[ProductRatePlanId], Writes.set[ProductRatePlanId])
